    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">DriveMyWay</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/find-parking" className="text-gray-300 hover:text-white">
                  Find Parking
                </Link>
              </li>
              <li>
                <Link href="/list-your-driveway" className="text-gray-300 hover:text-white">
                  List Your Driveway
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-300">
            <div className="flex items-center">
              ...
              <span>support@drivemyway.com</span>
            </div>
            <div className="flex items-center">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>&copy; 2024 DriveMyWay. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
